...
public class AvoidNoArgumentSuperConstructorCallTest extends AbstractRecipeTestSupport {
    ...
    public AvoidNoArgumentSuperConstructorCallTest() {
    }
    ...
    public void checkDescription() {
        final AvoidNoArgumentSuperConstructorCall recipe =
                new AvoidNoArgumentSuperConstructorCall();
    ...
    @RecipeTest
    void nestedSuperCall(ReportParser parser) throws Exception {
        verify(parser, "NestedSuperCall");
    }
