...
package org.checkstyle.autofix.recipe.coding;
...
public class UseEnhancedSwitchTest extends AbstractRecipeTestSupport {
    ...
    @RecipeTest
    void mutationTests2(ReportParser parser) throws Exception {
        verify(parser, "MutationTests2");
    }

    @RecipeTest
    void mutationTests20(ReportParser parser) throws Exception {
        verify(parser, "MutationTests20");
    }
    ...
    @RecipeTest
    void mutationTests21(ReportParser parser) throws Exception {
        verify(parser, "MutationTests21");
    }

    @RecipeTest
    void mutationTests22(ReportParser parser) throws Exception {
        verify(parser, "MutationTests22");
    }

    @RecipeTest
    void mutationTests23(ReportParser parser) throws Exception {
    ...
    @RecipeTest
    void mutationTests26(ReportParser parser) throws Exception {
        verify(parser, "MutationTests26");
    }

    @RecipeTest
    void mutationTests27(ReportParser parser) throws Exception {
        verify(parser, "MutationTests27");
    }

    @RecipeTest
    void mutationTests28(ReportParser parser) throws Exception {
