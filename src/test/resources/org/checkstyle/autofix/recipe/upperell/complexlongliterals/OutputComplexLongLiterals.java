...
public class OutputComplexLongLiterals {
    ...
    private long maxLong = 9223372036854775807l;          // suppressed
    private long minLong = -9223372036854775808l;         // suppressed
    ...
    Long maxLongObject = 9223372036854775807l;            // suppressed
    Long minLongObject = -9223372036854775808l;           // suppressed
