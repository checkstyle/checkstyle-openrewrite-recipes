...
| 🟢     | [`MissingDeprecated`](https://checkstyle.sourceforge.io/checks/annotation/missingdeprecated.html#MissingDeprecated)         | [`MissingDeprecated`](https://github.com/checkstyle/checkstyle-openrewrite-recipes/blob/main/src/main/java/org/checkstyle/autofix/recipe/MissingDeprecated.java) |                |
...
| 🟢     | [`OpenjdkAnnotationLocation`](https://checkstyle.sourceforge.io/checks/annotation/openjdkannotationlocation.html#OpenjdkAnnotationLocation)         | `TBD`            |                |
...
| 🟢     | [`AvoidNoArgumentSuperConstructorCall`](https://checkstyle.sourceforge.io/checks/coding/avoidnoargumentsuperconstructorcall.html#AvoidNoArgumentSuperConstructorCall) | [`AvoidNoArgumentSuperConstructorCall`](src/main/java/org/checkstyle/autofix/recipe/AvoidNoArgumentSuperConstructorCall.java)           |                |
...
| 🟢     | [`UnnecessaryTypeArgumentsWithRecordPattern`](https://checkstyle.sourceforge.io/checks/coding/unnecessarytypeargumentswithrecordpattern.html#UnnecessaryTypeArgumentsWithRecordPattern) | `TBD`           |                |
...
| 🟢     | [`UnnecessaryParentheses`](https://checkstyle.sourceforge.io/checks/coding/unnecessaryparentheses.html#UnnecessaryParentheses) | [`UnnecessaryParentheses`](https://github.com/checkstyle/checkstyle-openrewrite-recipes/blob/main/src/main/java/org/checkstyle/autofix/recipe/UnnecessaryParentheses.java) |                |
...
| 🟢     | [`MultilineCommentLeadingAsteriskPresence`](https://checkstyle.sourceforge.io/checks/misc/multilinecommentleadingasteriskpresence.html#MultilineCommentLeadingAsteriskPresence) | `TBD` | |
...
| 🟢     | [`TypeBodyPadding`](https://checkstyle.sourceforge.io/checks/whitespace/typebodypadding.html#TypeBodyPadding)                 | `TBD`           |                |
...
| 🟢     | [`WhitespaceBeforeEmptyBody`](https://checkstyle.sourceforge.io/checks/whitespace/whitespacebeforeemptybody.html#WhitespaceBeforeEmptyBody)                 | `TBD`           |                |
