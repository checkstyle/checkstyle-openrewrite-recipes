...
| 🟢     | [`CustomImportOrder`](https://checkstyle.sourceforge.io/checks/imports/customimportorder.html#CustomImportOrder)           | [`CustomImportOrder`](https://github.com/checkstyle/checkstyle-openrewrite-recipes/blob/main/src/main/java/org/checkstyle/autofix/recipe/CustomImportOrder.java)           | Delegates to OpenRewrite OrderImports; Checkstyle custom group config is not mapped. |
